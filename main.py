...
channel_id = "" #channeld_id goes here. Channel id can be copied from the client by enabling dev mode.
msglimit = None #set number of msgs to fetch. Default is set to None.
